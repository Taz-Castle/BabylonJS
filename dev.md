...
Element 5 features 2 scenes that can be swapped between using buttons implemented through GUI. The fifth element gives the biggest chance to be creative, so for my fifth element, I reused previous elements and combined elements from other scenes to make my own.
